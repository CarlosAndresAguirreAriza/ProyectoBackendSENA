...
class JWT(models.Model):
    ...
    class Meta:
        db_table = "authentication.jwt"
        verbose_name = "JWT"
        verbose_name_plural = "JWT's"

    def __str__(self) -> str:
        """This method returns a string representation of the JWT token."""
...
class JWTBlacklist(models.Model):
    ...
    class Meta:
        db_table = "authentication.jwt_blacklist"
        verbose_name = "JWT Blacklist"
        verbose_name_plural = "JWT Blacklist"

    def __str__(self) -> str:
        """This method returns a string representation of the blacklisted JWT token."""
