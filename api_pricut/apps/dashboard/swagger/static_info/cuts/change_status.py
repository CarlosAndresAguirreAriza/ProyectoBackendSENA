...
CutStatusSerializerSchema = extend_schema_serializer(
    examples=[
        OpenApiExample(
            name="data_valid",
            summary="Request data",
            description=f"These are the data required to change the status of a cutting technique:\n- **Status:** This field is required.\n\nFields other than those defined for this request are not allowed.",
            value={"status": False},
            request_only=True,
        ),
    ],
...
@CutStatusSerializerSchema
class CutStatusSerializer(Serializer):
    pass


CutStatusSchema = extend_schema(
    operation_id="change_cut_status",
    tags=["Dashboard"],
    parameters=[
        OpenApiParameter(
            name="cut_code",
    ...
    responses={
        200: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    description="The status of the cutting technique was updated successfully. The **modified_thicknesses** field indicates whether the information for all materials cached in the browser needs to be updated.",
        ...
        401: OpenApiResponse(
            description="**(UNAUTHORIZED)** The JWT is not valid to continue with the request or cannot be completed.",
            response={
                "properties": {
                    "code": {"type": "string"},
                    "detail": {"type": "string"},
            ...
            examples=[
                ...
                OpenApiExample(
                    ...
                    description="This response is returned when attempting to activate a cutting technique that is already active or deactivate a cutting technique that is already deactivated.",
                    value={
        ...
        403: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    description="This response is displayed when the user does not have permission to change the status of a cutting technique.",
                    value={
        ...
        404: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    description="The cutting technique with the specified code was not found in the database.",
                    value={
