...
DeleteThicknessSchema = extend_schema(
    operation_id="delete_thickness",
    tags=["Dashboard"],
    parameters=[
        OpenApiParameter(
            name="thickness_id",
    ...
    responses={
        200: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    name="delete_thickness",
                    summary="Thickness deleted",
                    description="The thickness information was deleted successfully. The **modified_thicknesses** field indicates whether the information for all materials cached in the browser needs to be updated.",
        ...
        403: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    description="This response is displayed when the user does not have permission to delete a thickness from a material or does not have the required role.",
                    value={
